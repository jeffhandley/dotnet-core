...
## Parse a PrereleaseLabel (e.g. "preview.7", "rc.1", "alpha.1") into internal
...
Function ParsePrereleaseLabel {
    ...
    Write-Error "Invalid prerelease label '$label'. Expected '<label>.N' where <label> is one of alpha, beta, preview, rc (e.g. 'preview.7', 'rc.1', 'alpha.1')." -ErrorAction Stop
}
